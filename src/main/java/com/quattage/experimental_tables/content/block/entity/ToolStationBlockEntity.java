...
import com.quattage.experimental_tables.util.ImplementedInventory;
import com.quattage.experimental_tables.util.util;
...
public class ToolStationBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory{
    ...
    public Text getDisplayName() {
        return util.newKey("toolStationBlockEntity");
    }
