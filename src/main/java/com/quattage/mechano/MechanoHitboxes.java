...
public class MechanoHitboxes {
	...
	public static final LazyRotatableHitbox CONNECTOR_SINGLE = new LazyRotatableHitbox(
		...
		.addBox(6.0, 0.1, 12.0, 10.0, 6.0, 13.9)
		.addBox(6.0, 0.1, 2.1, 10.0, 6.0, 4.0)
		.addBox(2.0, 4.0, 6.0, 4.0, 6.0, 10.0)
		.addBox(12.0, 4.0, 6.0, 14.0, 6.0, 10.0)
		.addBox(5.5, 6.0, 5.5, 10.5, 19.0, 10.5)
		.addBox(4.0, 4.0, 4.0, 12.0, 9.0, 12.0)
		.addBox(4.0, 10.0, 4.0, 12.0, 15.0, 12.0)
		.addBox(4.0, 16.0, 4.0, 12.0, 18.0, 12.0)
		.optimize().make()
	);
