...
import com.quattage.mechano.api.griddable.Griddable.Visual;
...
public class AnchorSelector {
    ...
    @Nullable private VectorOperations.Ray lookingRay; // TODO instance.hitresult with additional clipping?
    ...
    public void tick(LocalPlayer player, DeltaTracker deltas) {
        ...
        this.lookingRay = VectorOperations.getLookingRay(player, deltas.getGameTimeDeltaPartialTick(false), (float)player.blockInteractionRange());
    ...
    public @Nullable VectorOperations.Ray getLookingRay() {
        return lookingRay;
    }
