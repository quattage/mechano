...
public class CatenaryMeshBuffer implements WorldlyObject {
    ...
    // TODO hardware acceleration/flywheel/simulated/othersuchbullshit
    ...
    public void resetMatrix() {
        data[1]  = 0; data[2]  = 0; data[3]  = 0;  // tangent
    ...
    // if the vertex shader expected triangle fans 
    // we'd only have to track 4 vertices here instead of 8
    ...
    /**
     * Place 4 vertices at the given position using this buffer's
     * up and right matrix vectors as a basis for its orientation.
     * the 4 resulting vertices create a diamond pattern with 
