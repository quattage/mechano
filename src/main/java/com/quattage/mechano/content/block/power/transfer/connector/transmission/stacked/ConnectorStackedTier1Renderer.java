...
public class ConnectorStackedTier1Renderer extends WireAnchorBlockRenderer<ConnectorStackedTier1BlockEntity> {

    public ConnectorStackedTier1Renderer(Context context) {
        super(context);
    }
