...
public class ConnectorStackedTier3Renderer extends ElectricBlockRenderer<ConnectorStackedTier3BlockEntity> {

    public ConnectorStackedTier3Renderer(Context context) {
        super(context);
    }
