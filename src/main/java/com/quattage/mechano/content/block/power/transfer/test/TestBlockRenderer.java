...
public class TestBlockRenderer extends SafeBlockEntityRenderer<ElectricBlockEntity> {

    public TestBlockRenderer(BlockEntityRendererProvider.Context context) {}

    @Override
    protected void renderSafe(ElectricBlockEntity blockEntity, float partialTicks, PoseStack ms, 
