...
public final class GlobalClientGrid extends SidedGridDispatcher {
    ...
    public Response<?> requestLink(AnchorPoint startAnchor, AnchorPoint endAnchor, TransmitterType<?> type) {
        ...
        if(!startAnchor.existsIn(getLevelReader())) {
        ...
        if(!endAnchor.existsIn(getLevelReader())) {
        ...
        } else if(startAnchor.getAddress().isApproximately(endAnchor.getAddress())) return Response.Link.FAIL_DUPLICATE;
