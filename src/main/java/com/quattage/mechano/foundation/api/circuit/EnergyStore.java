...
public abstract class EnergyStore {
    ...
    protected final BifrucatedLong internalCharge;

    public EnergyStore() {
        this.internalCharge = BifrucatedLong.ZERO.mutableCopy();
    }
    ...
    public double getStateOfCharge() {
        return (double)Math.max((internalCharge.doubleValue() / getDatasheet().getRatedAmpHours()), 0d);
    }
     ...
     */
    public BifrucatedLong getStoredCharge() {
    ...
    public EnergyStore fillEnergy() {
        this.internalCharge.setValue(getDatasheetSafe().getRatedAmpHours());
        return this;
    }
