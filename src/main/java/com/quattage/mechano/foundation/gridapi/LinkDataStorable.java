...
import com.quattage.mechano.foundation.gridapi.LinkDataStorable.Client;
import com.quattage.mechano.foundation.gridapi.LinkDataStorable.ClientSectionable;
import com.quattage.mechano.foundation.gridapi.LinkDataStorable.Server;
import com.quattage.mechano.foundation.gridapi.LinkDataStorable.ServerSectionable;
...
public sealed interface LinkDataStorable<T extends GridConnection> permits Client, Server, ClientSectionable, ServerSectionable {
    ...
    public static @Nullable Server getAsServer(BlockEntity be, boolean force) {
        ...
        if(force) data = be.getData(MechanoData.LINK_ATTACHMENT);
        else data = be.getExistingDataOrNull(MechanoData.LINK_ATTACHMENT);
        return (Server)data;
    }
    ...
    public static @Nullable ServerSectionable getAsServer(ChunkAccess chunk, boolean force) {
        ...
        LinkDataStorable<?> data;
        if(force) data = chunk.getData(MechanoData.LINK_ATTACHMENT);
        else data = chunk.getExistingDataOrNull(MechanoData.LINK_ATTACHMENT);
    ...
    public static @Nullable Server getAsServer(Entity e, boolean force) {
        ...
        assertSided(e, false);
        LinkDataStorable<?> data;
        if(force) data = e.getData(MechanoData.LINK_ATTACHMENT);
        else data = e.getExistingDataOrNull(MechanoData.LINK_ATTACHMENT);
        return (Server)data;
    }
