...
import com.quattage.mechano.grid.HierarchicalConstruct.TerminalProvider;
...
public abstract class StampingComponent extends DiscreteComponent implements TerminalProvider {
     ...
     */
    public abstract void stamp(GridDomain domain, NodalSolver solver);
    ...
    public interface StampsDynamically {
         ...
         * @see #stamp
         */
        void stampDynamic(GridDomain domain, NodalSolver solver);
    }
    ...
    public interface NeedsPostProcessing {
         ...
         */
        void postProcess(GridDomain domain, NodalSolver solver);
    }
    ...
    public interface CurrentChangeCallback {
         ...
         */
        void onCurrentUpdated(GridDomain domain, PowerState then, PowerState now);
    }
    ...
    public static class PowerState {
        ...
        public double joules() {
            return watts() * SolverMethod.DELTA;
        }
        ...
        public double ampHours() {
            return amps() * SolverMethod.DELTA / 3600d;
        }

        public boolean isCurrentEqual(PowerState other) {
            return Math.abs(other.amps() - this.amps()) < SolverMethod.EPSILON;
        }

        public boolean isVoltageEqual(PowerState other) {
            return Math.abs(other.volts() - this.volts()) < SolverMethod.EPSILON;
        }
