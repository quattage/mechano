...
public class ComponentLink<T extends CircuitComponent> extends AncillaryPair {
    ...
    public @Nullable CircuitComponent makeComponent(ServerGrid grid, Netlist netlist, int netlistIndex) {
        this.component = TransmitterType.applyUnion(netlist, trns.getFactory(), this);
